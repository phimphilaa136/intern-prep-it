...
function TeacherRegister() {
  ...
  const handleSubmit = async e => {
    ...
    if (form.password.length < 4 || form.password.length > 6) {
      setAlert({ type: 'error', message: 'รหัสผ่านต้องเป็นตัวเลข 4-6 หลัก' });
      return;
    }
    try {
  ...
  return (
    <div className="register-container styled-bg" style={{
      ...
      <div style={{
        ...
        <h2 className="register-title" style={{marginBottom:'1.5rem',color:'#2979ff',fontWeight:'bold',fontSize:'1.35rem'}}>ลงทะเบียนอาจารย์ฝ่ายสหกิจ</h2>
        {alert && (
          <div style={{
            position:'fixed',
            top:'2.5rem',
        ...
        <form className="login-form" onSubmit={handleSubmit} style={{
          ...
          <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:'1rem'}}>
            ...
            <input type="text" name="full_name" placeholder="ชื่อนามสกุล" value={form.full_name} onChange={handleChange} required style={{
              width:'100%',
              padding:'0.7rem',
              borderRadius:'10px',
              border:'1.5px solid #e0e0e0',
          ...
          <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:'1rem'}}>
            <input type="text" name="faculty" placeholder="คณะ" value={form.faculty} onChange={handleChange} required style={{
              width:'100%',
              padding:'0.7rem',
              borderRadius:'10px',
              border:'1.5px solid #e0e0e0',
            ...
            <input type="text" name="major" placeholder="สาขา" value={form.major} onChange={handleChange} required style={{
              width:'100%',
              padding:'0.7rem',
              borderRadius:'10px',
              border:'1.5px solid #e0e0e0',
          ...
          <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:'1rem'}}>
            <input type="email" name="email" placeholder="อีเมล" value={form.email} onChange={handleChange} required style={{
              width:'100%',
              padding:'0.7rem',
              borderRadius:'10px',
              border:'1.5px solid #e0e0e0',
          ...
          {/* ช่องกรอกที่อยู่เดี่ยว ให้ความกว้างเท่ากับช่องชื่อผู้ใช้ */}
